...
function createFromRepo(repoUrl, projectName) {
...
if (!repoUrl || !projectName) {
    ...
    console.error("\nExamples:");
    console.error("  boilerplate-cli https://github.com/user/nestjs-template.git my-api");
    console.error("  boilerplate-cli git@github.com:user/nextjs-template.git my-app");
    process.exit(1);
}
